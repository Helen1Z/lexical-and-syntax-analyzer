...
oso_loop : OSO '(' condition ')' '{' stmt_list ';' '}' {print_token("OSO", "Syntax ok");}
         ;
an_loop : AN '(' condition ')' '{' stmt_list ';' '}' ALLIWS '{' stmt_list ';' '}'
...
var_list : var_list ',' expr {print_token(",", "Syntax ok"); }
         | expr {print_token(" ", "Syntax ok"); }
         ;


keywords : GRAPSE '(' expr ')' { print_token("grapse", "Syntax ok");}
         | DIABASE '(' expr ')' { print_token("diabase", "Syntax ok");}
